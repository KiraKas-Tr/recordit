#!/usr/bin/env python3
"""Summarize v1 acceptance checks for cold/warm first emit, artifact truth, and pressure trust surfaces."""
...
def main() -> None:
    ...
    gate_pass = all(
        [
            cold_emit["first_emit_during_active"],
            warm_emit["first_emit_during_active"],
